...
En esta sección, el equipo define los requisitos funcionales y técnicos de los productos digitales a partir del análisis de la información obtenida. Se inicia con la especificación de User Stories y Criterios de Aceptación, se continúa con el Impact Mapping para conectar los objetivos de negocio con el desarrollo, y se finaliza con el Product Backlog estimado y priorizado.

## 3.1. User Stories.

A continuación, se presentan las épicas y User Stories definidos para el desarrollo de NodeSecure, estructurados con sus respectivos criterios de aceptación (formato Gherkin).
...
| **US25** | Registar usuario | Como dueño de PYME, quiero registrarme en el sistema para usar la plataforma. | **Given** el usuario ingresa datos válidos, **When** se registra, **Then** el sistema crea la cuenta.<br>**Given** datos inválidos, **When** intenta registrarse, **Then** el sistema rechaza el registro. | EP02, EP09 |
...
* **Epic 01: Monitoreo y visualización de almacenes:** US01, US02, US03, US17, US28, US32, US51, US52.
* **Epic 02: Gestión de usuarios y almacenes:** US04, US05, US13, US19, US20, US25, US26, US33, US36, US43, US49.
* **Epic 03: Alertas y seguridad activa:** US06, US07, US14, US16, US29, US30, US50, US53, US54.
* **Epic 04: Historial, auditoría y reportes:** US08, US10, US11, US12, US15, US31, US55, US56.
* **Epic 05: Integraciones técnicas y API RESTful:** TS09, TS18, TS27, US34, TS35, TS44, TS45, TS46, TS47, TS48.
* **Epic 06: Landing Page y adquisición de usuarios:** US21, US22, US23, US24, US57, US58.
* **Epic 07: Suscripciones y pagos:** US36, US37, US38, US42, TS45, TS48, US59.
* **Epic 08: Gestión de sensores IoT y zonas:** US39, US40, US41, US50, TS44, TS46, TS47, US60.
* **Epic 09: Seguridad de acceso e identidad:** US19, US20, US25, US33, US43, TS27, TS35.
* **Epic 10: Experiencia de usuario y accesibilidad:** US17, US28, US32, US51, US52, US57, US58.


## 3.2. Impact Mapping.

En esta sección el equipo explica y presenta el Impact Mapping para el modelo de negocio digital de NodeSecure. El objetivo es visualizar la relación entre las metas de negocio, los actores (User Personas), los impactos (cambios de comportamiento esperados) y los entregables (User Stories/Features) que permitirán alcanzar dichos objetivos.

**Segmento 1: Dueños y Administradores de PYMES**
*(Aquí va la imagen de tu Impact Map para el Segmento 1)*
![Impact Mapping - Segmento 1](images/impact-mapping-seg1.png)

**Segmento 2: Jefes de Seguridad y Operaciones**
*(Aquí va la imagen de tu Impact Map para el Segmento 2)*
![Impact Mapping - Segmento 2](images/impact-mapping-seg2.png)


## 3.3. Product Backlog.

A continuación, se presenta el Product Backlog estimado y priorizado de NodeSecure. Se han asignado Story Points utilizando la sucesión de Fibonacci (1, 2, 3, 5, 8) para estimar el esfuerzo y la complejidad de cada historia. La priorización busca entregar valor desde el primer Sprint, comenzando por el Landing Page y las funciones críticas de acceso y gestión.
